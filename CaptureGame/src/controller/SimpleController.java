...
public class SimpleController implements IGoController {
    ...
    public void run() {
        ...
        while (true) {
            ...
            catch (IllegalArgumentException e){ System.out.print("No way to do that\n"); continue; }
            catch (ArrayIndexOutOfBoundsException e2) {System.out.print("Are you sure you know how to play this game ?\n"); continue; }
